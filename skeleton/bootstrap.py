...
from skeleton.core.scripts import *
from skeleton.core.request import Request
from skeleton.core.login import LoginAction
from skeleton.core.crawler import Crawler, WebFinder
from skeleton.core.utils import uniquinize
from skeleton.core.database import SQLiteWriter
from skeleton.core.webapps import WebAppModuleLoader
from skeleton.ext.mefjus.ghost import Mefjus
from skeleton.core.scope import Scope
from skeleton.core import scanner, modules
from skeleton.ext.libcms.cms_scanner_core import CustomModuleLoader
from skeleton.ext.metamonster import metamonster
...
class skeleton:
    ...
    def start(self):
        self.logger = logging.getLogger("skeleton")
        ...
        self.logger.info("Starting skeleton")
