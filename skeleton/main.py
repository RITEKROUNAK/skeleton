...
# This will start the skeleton framework
...
def main():
    ...
    group_adv.add_argument('--database', help='The SQLite database to use', dest='db', default="skeleton.db")
    ...
    instance = skeleton.skeleton(opts)
    try:
