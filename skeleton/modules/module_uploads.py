...
import skeleton.modules.module_base
from skeleton.core.utils import requests_response_to_dict, random_string
from bs4 import BeautifulSoup


class Module(skeleton.modules.module_base.Base):
